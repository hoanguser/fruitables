...
<div class="about_section layout_padding">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="about_img"><img src="../../public/image/about-img.png"></div>
         </div>
      </div>
   </div>
</div>
            ...
            echo '   
               <div class="col-md-3">
                  <div class="container_main">
                     <img src="../../public/image/'.$item['image'].'" alt="Avatar" class="image">
                     <p>'.$item['Name'].'</p>
                     <p>Giá: ' . number_format(($item['Price'] - ($item['Price'] * ($item['Sale'] / 100)))) . 'VND</p>
                     <div class="overlay">
                        <div class="text"><a href="/detail?id='.$item['id_sp'].'"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                     </div>
                  </div>
               </div> ';
        }
      ...
      ?>
         ...
         <div class="gallery_section_2">
            <div class="row">
               <div class="col-md-3">
                  <div class="container_main">
                     <img src="../../public/image/img-4.png" alt="Avatar" class="image">
                     <div class="name">
               ...
               <div class="col-md-3">
                  <div class="container_main">
                     <img src="../../public/image/img-5.png" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="overlay">
                           <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                        </div>
               ...
               <div class="col-md-3">
                  <div class="container_main">
                     <img src="../../public/image/img-6.png" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="overlay">
                           <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                        </div>
               ...
               <div class="col-md-3">
                  <div class="container_main">
                     <img src="../../public/image/img-3.png" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                     </div>
                  </div>
      ...
      <div class="services_section_2">
         <div class="row">
            <div class="col-lg-4 col-sm-12 col-md-4">
               <div class="box_main active">
                  <div class="house_icon">
                     <img src="../../public/image/icon1.png" class="image_1">
                     <img src="../../public/image/icon1.png" class="image_2">
                  </div>
            ...
            <div class="col-lg-4 col-sm-12 col-md-4">
               <div class="box_main">
                  <div class="house_icon">
                     <img src="../../public/image/icon2.png" class="image_1">
                     <img src="../../public/image/icon2.png" class="image_2">
                  </div>
            ...
            <div class="col-lg-4 col-sm-12 col-md-4">
               <div class="box_main">
                  <div class="house_icon">
                     <img src="../../public/image/icon3.png" class="image_1">
                     <img src="../../public/image/icon3.png" class="image_2">
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="testimonial_section_2">
                           <h4 class="client_name_text">Monila <span class="quick_icon"><img src="../../public/image/quick-icon.png"></span></h4>
