...
<head>
    ...
    <!-- Core Css -->
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/datatables.min.css">
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/line-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/jquery.mCustomScrollbar.css">
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/bootstrap-slider.css">

    <!-- Custom Css -->
    <link rel="stylesheet" type="text/css" href="../../public/css/assets/css/style.min.css">
...
<body>
    ...
    <div class="br-sideleft">
        ...
        <div class="br-logo d-flex justify-content-center align-items-center">
            <a href="index.html"><img src="../../public/css/assets/image/logo.png" alt="MS Admin Panel" width="80" /></a>
        </div>
        <ul class="custom-scroll">
            <li class="active"><a href="/admin" class="waves-effect waves-primary"><i class="la la-dashboard"></i>Dashboard</a></li>
            <li><a href="/ad_elements" class="waves-effect waves-primary"><i class="la la-clone"></i>Elements</a></li>
            <!-- <li><a href="javascript:;" class="waves-effect waves-primary"><i
                        class="la la-bullhorn"></i>Campaign</a></li> -->
            <li><a href="/ad_product" class="waves-effect waves-primary"><i class="la la-clone"></i>Elements</a></li>
            ...
            <li><a href="/ad_product" class="waves-effect waves-primary"><i class="la la-cart-arrow-down"></i>Products</a></li>
            <li><a href="/qldh_admin" class="waves-effect waves-primary"><i class="la la-wechat"></i>Order management</a></li>
                ...
                <nav class="nav">
                            ...
                            <div class="media-list">
                                ...
                                <a href="" class="media-list-link">
                                    <div class="media d-flex align-items-center py-2 px-2">
                                        <img src="../../public/css/assets/image/img1.jpg" width="50" class="rounded-circle" alt="">
                    ...
                    <div class="dropdown">
                        <a href="" class="nav-link-profile d-flex dropdown-toggle" data-toggle="dropdown" id="dropdownprofile">
                            <img src="../../public/css/assets/image/img3.jpg" class="rounded" alt="" width="50">
                            <span class="logged-name px-3">
                                <?php
                                if (isset ($_SESSION['name']) && ($_SESSION['name']) != "" && $_SESSION['role'] == 1) {
                                    echo $_SESSION['name'];
                                }
                                ?>
                                <br><small class="pt-3">Founder</small></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-header dropdown-menu-user" aria-labelledby="dropdownprofile">
                            <div class="text-center">
                                <a href=""><img src="../../public/css/assets/image/img3.jpg" width="80" class="rounded-circle" alt=""></a>
                                <h6 class="logged-fullname font-weight-bold mt-2">
                                    <?php
                                    if (isset($_SESSION['name']) && ($_SESSION['name']) != "" && $_SESSION['role'] == 1) {
                                        echo $_SESSION['name'];
                                        echo '</h6><p class="my-0">' . $_SESSION['email'] . '</p>';
                                    }
                                    ?>
                            </div>
                            <hr>
                            <ul class="list-unstyled user-profile-nav">
                                ...
                                <li><a href="javascript:;" class=" waves-effect waves-light"><i class="la la-cog"></i>
                                        Settings</a></li>
                                <li><a href="/" class=" waves-effect waves-light"><i class="la la-download"></i>Back user</a></li>
                                <li><a href="javascript:;" class=" waves-effect waves-light"><i class="la la-star-o"></i> Favorites</a></li>
                                <li><a href="javascript:;" class=" waves-effect waves-light"><i class="la la-file"></i>
                                        Collections</a></li>
                                <li><a href="/signout" class=" waves-effect waves-light"><i class="la la-power-off"></i> Sign Out</a></li>
                            </ul>
                        </div>
                        <!-- dropdown-menu -->
                    </div>
